...
// Expose functions globally to window for Team Leader workspace
window.openAdminCounsellorCrmWorkspace = openAdminCounsellorCrmWorkspace;
window.closeAdminCounsellorCrmWorkspace = closeAdminCounsellorCrmWorkspace;
window.switchAdminCrmTab = switchAdminCrmTab;
window.markAdminCounsellorAttendanceModal = typeof markAdminCounsellorAttendanceModal !== 'undefined' ? markAdminCounsellorAttendanceModal : function(){};
window.filterAdminCrmActivity = typeof filterAdminCrmActivity !== 'undefined' ? filterAdminCrmActivity : function(){};
window.filterAdminCrmLeads = typeof filterAdminCrmLeads !== 'undefined' ? filterAdminCrmLeads : function(){};
window.filterAdminCrmFollowups = typeof filterAdminCrmFollowups !== 'undefined' ? filterAdminCrmFollowups : function(){};
window.renderWorkspaceAnalytics = typeof renderWorkspaceAnalytics !== 'undefined' ? renderWorkspaceAnalytics : function(){};
window.renderWorkspaceOverview = typeof renderWorkspaceOverview !== 'undefined' ? renderWorkspaceOverview : function(){};
window.renderWorkspaceActivity = typeof renderWorkspaceActivity !== 'undefined' ? renderWorkspaceActivity : function(){};
window.renderWorkspaceLeads = typeof renderWorkspaceLeads !== 'undefined' ? renderWorkspaceLeads : function(){};
window.renderWorkspaceFollowups = typeof renderWorkspaceFollowups !== 'undefined' ? renderWorkspaceFollowups : function(){};
window.renderWorkspaceAttendance = typeof renderWorkspaceAttendance !== 'undefined' ? renderWorkspaceAttendance : function(){};
